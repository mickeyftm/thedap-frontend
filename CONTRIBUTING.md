# Contributing to thedap ecosystem

Thanks for taking the time to contribute !
You can start by reading our [Contribution guidelines](https://docs.thedap.space/code/contributing) first.
...
```
t(`You have %num% left in your wallet`, { num: dapBalance })
```
